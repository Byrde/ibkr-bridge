...
| **Market Data API** | Implement instrument search endpoint | GET /instruments?q={query} returns matching instruments with symbol, type, exchange, conid. | `Ready to Test` |  | Required to resolve symbols for trading. |
